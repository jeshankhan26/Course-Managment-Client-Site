  ...
  const handleDelete = (id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        fetch(`https://course-server-beta-three.vercel.app/course/${id}`, {
          method: "DELETE",
          headers: {
              ...
              {matchedCourses.map((course, index) => (
                <tr key={index}>
                  ...
                  <td className="flex flex-wrap gap-2">
                    <NavLink
                      to={`/edit/${course._id}`}
                      className="btn btn-xs bg-blue-500 hover:bg-blue-600 text-white shadow-md transition duration-200 ease-in-out"
                    >
                      Edit
                    </NavLink>
                    ...
                    <button
                      ...
                      className="btn btn-xs bg-red-500 hover:bg-red-600 text-white shadow-md transition duration-200 ease-in-out"
                    >
                      <svg
